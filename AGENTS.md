...
- Single-page app: one `index.html` with a tab-style nav that swaps between four views (no page reloads): Agent Spark, Blueprint Lab, Admin ("สำหรับทีม Admin"), and Live (public projection screen).
